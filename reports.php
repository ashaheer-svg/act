...
if ($type === 'matrix') {
    ...
    switch($type) {
        ...
        case 'monthly':
            ...
            $reportTitle = 'Monthly Performance Matrix — ' . $matrixData['period_title'];
            break;
        case 'quarterly':
                ...
                <div class="command-bar">
                    <div class="cmd-left">
                        <div class="cmd-group">
                            ...
                            <select class="cmd-select cmd-select-report" onchange="window.location.href='reports.php?type='+this.value">
                                <optgroup label="── Active Strategic Analytics ──">
                                    ...
                                    <option value="monthly" <?php echo $type === 'monthly' ? 'selected' : ''; ?>>Monthly Sales Matrix</option>
                        ...
                        <div class="cmd-group">
                            ...
                            <select class="cmd-select" onchange="window.location.href='reports.php?type=monthly&year=<?php echo urlencode($selectedYear ?? $year); ?>&mode='+this.value">
                        ...
                        <div class="cmd-group">
                            ...
                            <select class="cmd-select" onchange="window.location.href='reports.php?type=monthly&mode=calendar&year='+this.value">
